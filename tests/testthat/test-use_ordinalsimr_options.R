...
test_that("get_ordinalsimr_options() returns a list of ordinalsimr options", {
  ...
  withr::with_options(list(ordinalsimr.default_iterations = 500,
    ...
    expect_equal(names(options), c("ordinalsimr.default_iterations",
...
test_that("check that set_ordinalsimr_options() works", {
  ...
  suppressMessages({
    ...
    set_ordinalsimr_options(default_iterations = 500,
                            default_size_min = 20,
