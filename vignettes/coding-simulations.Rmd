...
calculate_power_t2error(formatted_results$p_values,
  alpha = 0.05,
...
sim_results <- run_simulations(
  ...
  sample_prob = c(0.5, 0.5),
  prob0 = c(0.1, 0.2, 0.3, 0.4),
  prob1 = c(0.1, 0.2, 0.3, 0.4), # note the matching probs. between groups
  niter = 20
)
...
calculate_t1_error(formatted_results$p_values,
  alpha = 0.05,
...
# supporting the nested tibble structure
