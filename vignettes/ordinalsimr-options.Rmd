...
If you're already familiar with the concept of options in R, you can skip this section and jump straight to the next one.
...
# this number will be printed to 3 *significant* digits because
0.093573827689
...
opt <- options()
ordinalsimr::set_ordinalsimr_options(default_iterations = 500)

# get the current value of the default number of iterations
get_ordinalsimr_options("default_iterations")
